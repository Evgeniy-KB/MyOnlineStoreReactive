...
public class BalanceApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BalanceResponse> getBalance() throws WebClientResponseException {
        ParameterizedTypeReference<BalanceResponse> localVarReturnType = new ParameterizedTypeReference<BalanceResponse>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BalanceResponse>> getBalanceWithHttpInfo() throws WebClientResponseException {
        ParameterizedTypeReference<BalanceResponse> localVarReturnType = new ParameterizedTypeReference<BalanceResponse>() {};
